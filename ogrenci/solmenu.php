<?php
$ogrenciler=mysqli_query($baglanti,"SELECT * FROM kullanicilar WHERE yetki=1 LIMIT 0,8");
$tumogrenciler=mysqli_query($baglanti,"SELECT * FROM kullanicilar WHERE yetki=1 ");
