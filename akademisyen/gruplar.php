...
<?php
  ...
  $olusturdugum = mysqli_query($baglanti,"SELECT * FROM gruplar INNER JOIN kullanicilar ON gruplar.grup_kuran_id=kullanicilar.kullanici_id WHERE gruplar.grup_kuran_id=$giris_yapan_id");
...
<!--İçerik Bitti-->
    ...
    <ul class="nav nav-tabs" style="padding:15px;background-color:#c7c8ca;">
      <li class="col-4 col-md-4"><a data-toggle="tab" href="#newGroups" class="show active">Tüm Gruplar</a></li>
      <li class="col-4 col-md-4"><a data-toggle="tab" href="#gruplar">Takip Ettiğim Gruplar</a></li>
      <li class="col-4 col-md-4"><a data-toggle="tab" href="#olusturdugum">Oluşturduğum Gruplar</a></li>
    </ul>
    ...
    <div class="tab-content">
      ...
      <div id="olusturdugum" class="tab-pane fade show active">

        <?php

          while ($tumGruplariGetir=mysqli_fetch_array($olusturdugum)) {
              echo '<div class="yeniAcilan">
                <a href="grup_ayrinti.php?grup_id='.$tumGruplariGetir["grup_id"].'"><img src="../images/gruplogolari/'.$tumGruplariGetir["grup_logo"].'" class="profil_foto3" width="60" height="60"/></a>
                <a href="grup_ayrinti.php?grup_id='.$tumGruplariGetir["grup_id"].'" class="paylasan_kullanici" style="font-size:18px;">'.$tumGruplariGetir["grup_adi"].'</a><br>
                <span class="tarafindan"><b>'.$tumGruplariGetir["grup_olusturma_tarihi"].'</b> tarihinde, </span><br/>
